...
public class SensorService {
    ...
    public Page<SensorDTO> listSensors(int page, int size, String sortBy, String codigoFiltro) {
        // The sortBy and codigoFiltro parameters are ignored for now, as the stored procedure does not support dynamic sorting or filtering.
        Page<Sensor> sensors = sensorRepository.findAll(page, size);
